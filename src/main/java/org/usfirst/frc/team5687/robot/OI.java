...
public class OI {
    ...
    public double getArmsSpeed() {
        return Helpers.applyDeadband(Gamepad.Axes.LEFT_TRIGGER.getNumber(), Constants.Deadbands.ARM) - Helpers.applyDeadband(Gamepad.Axes.RIGHT_TRIGGER.getNumber(), Constants.Deadbands.ARM);
    }
