 ...
 */
public class AutoTraverseCenterAndShootBuilder extends Command {
    ...
    protected void initialize() {
        ...
        DriverStation.reportError("Building autotraverse-center-and-shoot for defense " + defense + " in position " + position,false);

        // Traverse the selected defense
        Scheduler.getInstance().add(new AutoTraverseCenterAndShoot(defense, position));
