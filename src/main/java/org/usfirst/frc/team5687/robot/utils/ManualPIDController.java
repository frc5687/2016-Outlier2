 ...
 */
public class ManualPIDController implements PIDInterface, LiveWindowSendable {
  ...
  public double calculate() {
    ...
    if (enabled) {
      ...
      synchronized (this) {
        ...
        DriverStation.reportError("PID Error 1: " + m_error, false);
        if (m_continuous) {
        ...
        DriverStation.reportError("PID Error 2: " + m_error, false);
